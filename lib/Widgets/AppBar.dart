...
Widget myAppBar(BuildContext context,Function openDrawer)
{
  return AppBar(
    ...
    title: Container(
      ...
      decoration: const BoxDecoration(color: Color(0xFF0071dc),image: DecorationImage(image: AssetImage("assets/images/logo-removebg-preview.png"),fit: BoxFit.cover)),),
        ...
        child: GestureDetector(
            ...
            child:  Hero(
                ...
                child: Stack(children: [
                  ...
                  Provider.of<CartProvider>(context).productsList.isNotEmpty?  Positioned(
                      top: 0,right: 0,
                      child: Container(width: 10,height: 10,decoration: BoxDecoration(color: Colors.red,borderRadius: BorderRadius.circular(50)),)) : SizedBox()
                ]))
        ),
      )
    ],

    bottom: PreferredSize(preferredSize: Size.fromHeight(MediaQuery.of(context).size.height*0.1),
    child: GestureDetector(
      onTap: ()
      {
