      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: GestureDetector(
            onTap: ()
            {
              Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context) { return DashboardPage(tabindex: 0); }));
            },
            child: Row(
              children: const [
                    ...
                    children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children:  [
                            ...
                            const Text("ELECTRONICS",style: TextStyle(fontSize: 13,color: Color(0xfffd9926),letterSpacing: 2),),

                            const SizedBox(height: 10,),

                              const Text("EcoStar 55' QLED",style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                            ...
                            const Text("GBP 109.99",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Color(0xfffd9926)),),
                          ],
                      ...
                      Positioned(
                          ...
                          child: GestureDetector(
                            onTap: ()
                            {
                              Navigator.push(context, CupertinoPageRoute(builder: (BuildContext context) =>  SingleProduct(tag: "Wishlist$index", productid: "Wishlist$index")));
                            },
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  const Text("View",style: TextStyle(fontSize: 12,color: Colors.white,fontWeight: FontWeight.bold),),
                                ],
                              ),
                            ),
                          )
