...
class _SingleBrandState extends State<SingleBrand> {
          ...
          child: AppBar(
            ...
            actions: [
              ...
              GestureDetector(
                  onTap: ()
                  {
                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => SearchPage(tag: "singlecat",)));
                  },
                  child: const Hero(
                      tag: "singlecat",
              ...
              child: ListView(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    {
                      setState(() {
                        inStoreColor = const Color(0xff2d2d2d);
                      });
                    },
                    child: Container(
                      alignment: Alignment.center,
                      ...
                      child: Text(
                        "In Store",
                        style:  TextStyle(color: (inStoreColor == const Color(0xff2d2d2d))? Colors.white : Colors.black ,fontWeight: FontWeight.bold,fontSize: 12),
                      ),
                    ),
                  ),
  ...
  Widget SearchBar(BuildContext context) {
    return GestureDetector(
      onTap: ()
      {
        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => SearchPage(tag: "searchbar",)));
      },
      child: Container(
        height: 40,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text("Delivery",style: TextStyle(color: Color(
                              0xffffffff),fontSize: 9),),
                        ),
                        ...
                        Container(
                          ...
                          child: const Text("Pickup",style: TextStyle(color: Color(
                              0xffffffff),fontSize: 9),),
                        ),
                      ],
                    ),
