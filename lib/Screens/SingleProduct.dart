...
class SingleProduct extends StatefulWidget {
  const SingleProduct({Key? key, required this.tag, required this.productid}) : super(key: key);
...
class _SingleProductState extends State<SingleProduct> {
  ...
  final paginationController = PageController(viewportFraction: 0.8, keepPage: true);
  ...
  Widget build(BuildContext context) {
    ...
    images.add(relatedProductsCon(context,
        "https://www.luxury-legs.com/images/zerres-sarah-fine-ribbed-velvet-jeans-p4248-194915_medium.jpg", "ZERRES", "Cora Crop Jeans", "79.00",
          ...
          child: Column(
            ...
            children: [
                    ...
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(color: Colors.white,
                            border: Border(bottom: BorderSide(color: Colors.black.withOpacity(0.1),width: 0.2))),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      BoxDecoration(color: Colors.white,
                          border: _currentIndex == 0? Border.all(color: Colors.black.withOpacity(0.6)) : const Border(),
                          boxShadow: [
                            BoxShadow(
                      ...
                      child: Container(
                        ...
                        decoration:  BoxDecoration(
                          color: Colors.white,
                          image: DecorationImage(image: NetworkImage("https://www.luxury-legs.com/images/zerres-vera-summer-trousers-p4356-209212_medium.jpg"))
                          // boxShadow: [
                          //   BoxShadow(
                          //     color: Colors.black.withOpacity(0.15),
                          //     blurRadius: 1,
                    ...
                    Container(
                      ...
                      decoration:
                      BoxDecoration(color: Colors.white,
                          border: _currentIndex == 1? Border.all(color: Colors.black.withOpacity(0.6)) : const Border(),
                          boxShadow: [
                            BoxShadow(
                                color: Colors.black.withOpacity(0.15),
                                blurRadius: 1,
                      ...
                      child: Container(
                        ...
                        decoration:  BoxDecoration(
                            color: Colors.white,
                            image: DecorationImage(image: NetworkImage("https://www.luxury-legs.com/images/zerres-vera-summer-trousers-p4356-209213_medium.jpg"))
                          // boxShadow: [
                          //   BoxShadow(
                          //     color: Colors.black.withOpacity(0.15),
                          //     blurRadius: 1,
                    ...
                    Container(
                      ...
                      decoration:
                      BoxDecoration(color: Colors.white,
                          border: _currentIndex == 2? Border.all(color: Colors.black.withOpacity(0.6)) : const Border(),
                          boxShadow: [
                            BoxShadow(
                                color: Colors.black.withOpacity(0.15),
                                blurRadius: 1,
                      ...
                      child: Container(
                        ...
                        decoration:  BoxDecoration(
                            color: Colors.white,
                            image: DecorationImage(image: NetworkImage("https://www.luxury-legs.com/images/zerres-vera-summer-trousers-p4356-209211_medium.jpg"))
                          // boxShadow: [
                          //   BoxShadow(
                          //     color: Colors.black.withOpacity(0.15),
                          //     blurRadius: 1,
                    ...
                    Container(
                      ...
                      decoration:
                      BoxDecoration(color: Colors.white,
                          border: _currentIndex == 3? Border.all(color: Colors.black.withOpacity(0.6)) : const Border(),
                          boxShadow: [
                            BoxShadow(
                                color: Colors.black.withOpacity(0.15),
                                blurRadius: 1,
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration:
                            BoxDecoration(color: Colors.white,
                                border: productColor == "Brown"? Border.all(color: Colors.black) : const Border(),
                                boxShadow: [
                          BoxShadow(
                              color: Colors.black.withOpacity(0.15),
                              blurRadius: 1,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration:
                            BoxDecoration(color: Colors.white,
                                border: productColor == "Black"? Border.all(color: Colors.black) : const Border(),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: productColor == "White"? Border.all(color: Colors.black) : const Border(),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration:
                            BoxDecoration(color: Colors.white,
                                border: productColor == "Red"? Border.all(color: Colors.black) : const Border(),
                ...
                onTap: ()
                {
                  showCupertinoModalPopup<void>(
                    ...
                    builder: (BuildContext context) => CupertinoActionSheet(
                      title:  Text('Select Size',style: TextStyle(color: Colors.black.withOpacity(0.9),fontSize: 20,fontWeight: FontWeight.bold),),
                      ...
                      actions: <CupertinoActionSheetAction>[
                        ...
                        CupertinoActionSheetAction(
                            ...
                            onPressed: () => Navigator.pop(context), child: const Text("Cancel",style: TextStyle(color: Colors.red),))
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 10,),
                          Text("ADD TO WISHLIST",style: TextStyle(color: Colors.black.withOpacity(0.75)),),
                        ],
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Accordion(
                            ...
                            children: [
                              ...
                              Row(
                                children: const [
                                  ...
                                  Text("Gaming X Trio",style: TextStyle(fontSize: 12),)
                                ],
                              ),
                              const SizedBox(
                                height: 5,
                              ...
                              Row(
                                children: const [
                                  ...
                                  Text("15 Mar, 2023",style: TextStyle(fontSize: 12),)
                                ],
                              ),
                              const SizedBox(
                                height: 10,
                     ...
                     Accordion(
                        ...
                        content: Text("No Updates Yet",style: TextStyle(fontSize: 12),)),
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    productsContainer2("https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MQD83?wid=400&hei=400&fmt=jpeg&qlt=90&.v=1660803972361",
                        "Airpods Pro",
                        "Apple",
                        "249"),

                    productsContainer2("https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MJ4X3?wid=400&hei=400&fmt=jpeg&qlt=95&.v=1621876626000",
                        "Beats Studio Buds",
                        "Beats",
                        "149.99")
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    productsContainer2("https://www.luxury-legs.com/images/zerres-carla-snake-trouser-p4358-209223_medium.jpg",
                        "Carla Snake Trousers",
                        "ZERRES",
                        "99.00"),

                    productsContainer2("https://www.luxury-legs.com/images/zerres-sarah-fine-ribbed-velvet-jeans-p4248-194915_medium.jpg",
              ...
              Container(
                ...
                {
                  return reviewCon(context,"Got to have 'em","States where I pretty good price and a great size I use two a day and it's something we have to buy","Mark$index");
                }),
              ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text("See all reviews",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12),),
                    ),
                  )
                ],
              )
  ...
  Widget relatedProductsCon(BuildContext context,String I1, String T1, String C1, String P1, String I2, String T2, String C2, String P2,)
  {
    return Container(
  ...
  Widget productsContainer(String image,String title,String category,String price)
  {
    return Stack(
      children: [
        ...
        Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Icon(Icons.favorite_outline,color: Colors.black,size: 20,weight: 0.1,),
              ),
            )
        ),
        ...
        Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                padding: EdgeInsets.only(left: 10,right: 18,top: 8,bottom: 8),
                decoration: BoxDecoration(
  ...
  Widget productsContainer2(String image,String title,String category,String price)
  {
    return Container(
...
Widget reviewCon(BuildContext context,String title, String comment, String name)
{
  return Container(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text("Verified Purchaser",style: TextStyle(color: Color(
                0xff51a81e),fontWeight: FontWeight.bold,fontSize: 11),),

            const Spacer(),

            Text("03/21/2023",style: TextStyle(color: Colors.black.withOpacity(0.4),fontSize: 12),)
          ],
        ),
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.thumb_up_outlined,color: Colors.black.withOpacity(0.75),size: 20,),
              ...
              child: Row(
                ...
                children: [
                  Transform(
                    ...
                    child: Icon(Icons.thumb_down_outlined,color: Colors.black.withOpacity(0.75),size: 20,),
                  ),
          ...
          child: Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("(4.6)",style: TextStyle(color: Colors.black.withOpacity(0.6),fontSize: 12),),
              )
            ],
          ),
        ),
            ...
            children: [
              ...
              Expanded(
                child: LinearPercentIndicator(
                  ...
                  trailing: SizedBox(
                      width: 20,
                      child: Text("20",style: TextStyle(color: Colors.black.withOpacity(0.6),fontSize: 12),)),
            ...
            children: [
              ...
              Expanded(
                child: LinearPercentIndicator(
                  ...
                  trailing: SizedBox(width: 20,child: Text("28",style: TextStyle(color: Colors.black.withOpacity(0.6),fontSize: 12),)),
                  //linearStrokeCap: LinearStrokeCap.butt,
                  backgroundColor: Color(0xffd5d5d5),
                  progressColor: Color(0xFF5D5D5D),
                ),
            ...
            children: [
              ...
              Expanded(
                child: LinearPercentIndicator(
                  ...
                  trailing: SizedBox(width: 20,child: Text("0",style: TextStyle(color: Colors.black.withOpacity(0.6),fontSize: 12),)),
                  //linearStrokeCap: LinearStrokeCap.butt,
                  backgroundColor: Color(0xffd5d5d5),
                  progressColor: Color(0xFF5D5D5D),
                ),
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 2),
                      child: Text("Got to have 'em",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 15),),
                    ),
                    ...
                    Padding(
                      ...
                      child: Text("States where I pretty good price and a great size I use two a day and it's something we have to buy",
                        style: TextStyle(color: Colors.black.withOpacity(0.4)),),
                    ),
